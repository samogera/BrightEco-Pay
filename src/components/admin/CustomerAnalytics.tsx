        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-6">
            <Card>
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">+20 schools from last month</p>
                </CardContent>
            </Card>
            <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">96% of total schools</p>
                </CardContent>
            </Card>
            <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium">ARPU (Termly)</CardTitle>
                    <Wallet className="h-5 w-5 text-muted-foreground" />
                </CardHeader>
                <CardContent>
                    <div className="text-2xl font-bold">KES 15,750</div>
                    <p className="text-xs text-muted-foreground">Average Revenue Per School</p>
                </CardContent>
            </Card>
        </div>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-5">
            <Card className="lg:col-span-2">
                <CardHeader>
                    ...
                    <CardDescription>Breakdown of schools by payment status.</CardDescription>
                </CardHeader>
            ...
            <Card className="lg:col-span-3">
                <CardHeader>
                    ...
                    <CardDescription>Revenue and new school signups over the last 6 months.</CardDescription>
                </CardHeader>
                <CardContent>
