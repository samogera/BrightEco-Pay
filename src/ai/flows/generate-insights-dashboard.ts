...
const GenerateInsightsDashboardInputSchema = z.object({
  ...
  overallRevenue: z.number().describe('The total revenue generated by the service.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant tasked with generating a dashboard of key performance indicators (KPIs) for BrightEco Pay.
  ...
  Generate a comprehensive dashboard content using the above KPIs. Be concise, clear, and actionable. Focus on insights and trends that can help improve the business.`,
});
